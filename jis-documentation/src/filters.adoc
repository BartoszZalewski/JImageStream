...
--
image::car.png[title="car", width="300", height="300]
--
...
.code
----
include::{sourcedir}/filters/AddImageFilterTest.java[tags=AddImageFilter]
----
image::AddImageFilter.png[title="Add Image Filter", width="300", height="300"]

==== AddImage filter with displacement

[source,java]
.code
----
include::{sourcedir}/filters/AddImageFilterWithDisplacementTest.java[tags=AddImageFilterWithDisplacement]
----
image::AddImageFilterWithDisplacement.png[title="Add Image With Displacement Filter", width="300", height="300"]
...
.code
----
include::{sourcedir}/filters/SubImageFilterTest.java[tags=SubImageFilter]
----
image::SubImageFilter.png[title="Sub Image Filter", width="300", height="300"]

==== SubImage filter with displacement

[source,java]
.code
----
include::{sourcedir}/filters/SubImageFilterWithDisplacementTest.java[tags=SubImageFilterWithDisplacement]
----
image::SubImageFilterWithDisplacement.png[title="Sub Image With Displacement Filter", width="300", height="300"]
